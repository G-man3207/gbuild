...
/// A built-in subagent type shared by the CLI (`gbuild-agent`) and other
...
mod tests {
    ...
    // match what the gbuild-shell MiniJinja templates render for the default
    // gBuild toolset (monitor + task + bash + read present, POSIX). The
