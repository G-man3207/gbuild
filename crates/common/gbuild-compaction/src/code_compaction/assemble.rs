//! Compacted-history assembly (gBuild's rebuild structure, generic).
//!
...
//! ```
//!
//! gBuild is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // gBuild keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn gbuild_order_recent_before_summary() {
