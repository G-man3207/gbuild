...
/// Claude.md / `.gbuild/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.gbuild` and compat dirs.
...
/// Mirrors the serde shape of `gbuild-agent`'s `AgentConfigFile`.
