...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain gBuild in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain gBuild in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `gbuild_voice::STT_LANGUAGES` (official Grok STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain gBuild opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "gbuild_night".
                default: "gbuild_night",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "gbuild_night".
                default: "gbuild_night",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "gbuild_day".
                default: "gbuild_day",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        // The `GBUILD_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // Catalog = official STT languages (see gbuild_voice::STT_LANGUAGES).
        SettingMeta {
