//! gbuild-pager: the gBuild TUI implementation.
//!
...
// minimal rendering lives in the sibling `gbuild-pager-minimal` crate; these
...
// `gbuild-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use gbuild_pager_render::{
