...
fn format_cost(m: &gbuild_shell::extensions::notification::PromptUsageModel) -> String {
    use gbuild_shell::extensions::notification::ticks_to_usd;
...
mod tests {
    use super::*;
    use gbuild_shell::extensions::notification::{PromptUsage, PromptUsageModel};
