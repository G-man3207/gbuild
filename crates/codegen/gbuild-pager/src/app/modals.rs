                        ...
                        match cmd {
                            ...
                            PaletteCommand::OpenExtensionsTab(tab) => {
                                ...
                                InputOutcome::Action(Action::OpenExtensionsModal {
                                    tab,
                                    trigger: gbuild_telemetry::events::ExtensionsModalTrigger::CommandPalette,
                                })
                            }
...
mod command_palette_vim_input_tests {
    ...
    fn open_command_palette(agent: &mut AgentView) {
        agent.active_modal = Some(ActiveModal::CommandPalette {
            entries: crate::views::modal::default_palette_entries(agent.prompt.slash_controller.screen_mode()),
