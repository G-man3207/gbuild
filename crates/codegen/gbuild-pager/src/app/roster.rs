...
/// `gbuild-shell/src/agent/handlers/session.rs::handle_roster_list`), which
...
mod tests {
    ...
    fn agent_entry() -> gbuild_shell::agent::roster::RosterEntry {
        use gbuild_shell::agent::roster as agent;
        agent::RosterEntry {
