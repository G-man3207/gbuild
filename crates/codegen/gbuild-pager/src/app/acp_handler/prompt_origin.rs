...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    gbuild_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        gbuild_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        gbuild_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        gbuild_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        gbuild_shell::session::PromptOrigin::TaskCompleted { .. }
            | gbuild_shell::session::PromptOrigin::SubagentCompleted { .. }
            | gbuild_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | gbuild_shell::session::PromptOrigin::NotificationDrain
    )
}
