...
use gbuild_shell::tools::todo::todo_item_from_plan_entry;
use gbuild_workspace::permission::bash_command_splitting::BashCommandHighlights;
...
use settings::{
    handle_models_update, handle_sessions_changed,
