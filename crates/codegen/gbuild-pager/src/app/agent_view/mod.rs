...
pub struct AgentView {
    ...
    pub context_state: Option<gbuild_shell::session::ContextInfo>,
    ...
    pub(crate) deferred_session_mode: Option<gbuild_tools::types::SessionMode>,
    ...
    match kind {
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(gbuild_telemetry::events::CreditLimitChoice::PayAsYouGo);
            gbuild_telemetry::session_ctx::log_event(
                gbuild_telemetry::events::CreditLimitUpsellClicked {
        ...
        LocalQuestionKind::FreeUsageUpsell { source } => {
            ...
            gbuild_telemetry::session_ctx::log_event(
                gbuild_telemetry::events::SuperGrokUpsellClicked {
                    source,
                    auth_method: None,
                },
            );
...
fn translate_project_select(
    ...
    use gbuild_telemetry::events::{ProjectPickerOutcome, ProjectPickerSelected};
    let project_dir_options = resolved_paths.len().saturating_sub(1);
    let emit = |outcome: ProjectPickerOutcome| {
        gbuild_telemetry::session_ctx::log_event(ProjectPickerSelected {
            outcome,
...
fn remember_mode_enabled() -> bool {
    let path = gbuild_tools::util::gbuild_home::gbuild_home().join("config.toml");
...
fn question_visible_h(
    ...
    prompt_height: u16,
    question: &gbuild_tools::implementations::gbuild::ask_user_question::Question,
    content_w: usize,
    preview: Option<&str>,
    fullscreen: bool,
    desc_cap: u16,
