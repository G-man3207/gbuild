...
fn mixed_report() -> DiagnosticReport {
    ...
    report.facts.color = ColorFacts {
        ...
        available_themes: vec![ThemeKind::GBuildNight, ThemeKind::GBuildDay],
        total_themes: ThemeKind::ALL.len(),
    };
...
fn human_mixed_fixture_is_exact() {
    assert_eq!(
        ...
        concat!(
            ...
            "  Some checks only run in gBuild. Start gBuild and run /doctor.\n",
            "\n",
        ...
        serde_json::json!({
            ...
            "facts": {
                ...
                "color": {
                    ...
                    "availableThemes": ["gbuild_night", "gbuild_day"],
                    "totalThemes": 5
                },
