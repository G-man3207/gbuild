...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. GBuildNight's dark band leaking into GBuildDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default GBuildNight, dark) after the user switches —
        // painting a dark band on a light GBuildDay canvas.
