...
pub use gbuild_tools::implementations::gbuild::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<gbuild_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: gbuild_telemetry::events::SuperGrokUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<gbuild_shell::sampling::types::ReasoningEffort>,
    },
    DoctorFix {
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> gbuild_tools::implementations::gbuild::ask_user_question::AskUserQuestionExtResponse {
    ...
    pub fn send_ext_response(
        &mut self,
        response: gbuild_tools::implementations::gbuild::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
