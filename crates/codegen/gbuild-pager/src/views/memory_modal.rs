...
pub fn build_entries(
    files: Vec<gbuild_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(
            file_label("/home/user/.gbuild/memory/MEMORY.md"),
            "MEMORY.md"
        );
        assert_eq!(
            file_label("/workspace/.gbuild/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use gbuild_shell::extensions::notification::MemoryFileInfo;
