...
const HERO_SUBTITLE: &str = "gBuild // unrestricted local agent harness";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&gbuild_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn ann(title: Option<&str>, message: Option<&str>) -> gbuild_announcements::RemoteAnnouncement {
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        pinned.cta = Some(gbuild_announcements::AnnouncementCta {
        ...
        dismissible.cta = Some(gbuild_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/grok".into()),
            caption: Some("or use Ctrl+O".into()),
        });
