//! Logo component for the terminal-safe gBuild ASCII wordmark.
...
/// Pure tier selection so tests can drive an explicit hidden state.
...
mod tests {
    ...
    #[test]
    fn logo_can_be_explicitly_hidden_at_every_height() {
