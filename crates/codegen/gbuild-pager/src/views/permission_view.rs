...
use gbuild_workspace::permission::bash_command_splitting::{
...
pub struct PermissionViewState {
    ...
    /// permissions). Imported from `gbuild-shell`, NOT duplicated locally.
...
/// ```text
///  3 [ ] Tell gBuild what to do differently
...
mod tests {
    ...
    ///
    /// ```text
    /// PERMISSION_UI_RENDER_REVIEW=1 cargo test -p gbuild-pager --lib \
    ...
    fn historic_bash_fixture_path() -> std::path::PathBuf {
        // CARGO_MANIFEST_DIR = crates/codegen/gbuild-pager
