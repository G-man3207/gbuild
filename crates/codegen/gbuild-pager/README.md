...
Terminal UI (TUI) for gBuild. Provides the interactive full-screen interface
...
- [Hook Examples](../gbuild-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`gbuild-hooks`)](../gbuild-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`gbuild-plugin-marketplace`)](../gbuild-plugin-marketplace/) — marketplace source loading, scanning, and install
