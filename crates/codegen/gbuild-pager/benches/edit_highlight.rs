...
//!
//! ```text
//! cargo bench -p gbuild-pager --bench edit_highlight
//! cargo bench -p gbuild-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use gbuild_pager::diff::{DiffHunk, DiffLine};
use gbuild_pager::scrollback::blocks::tool::{
...
use gbuild_pager::syntax::{Syntect, get_syntect};
