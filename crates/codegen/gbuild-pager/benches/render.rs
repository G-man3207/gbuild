//! Criterion benchmarks for the gbuild-pager rendering pipeline.
//!
...
use gbuild_pager::scrollback::render::render_scrolled_entries_with_scratch;
use gbuild_pager::scrollback::wrappers::EntryRenderer;
use gbuild_pager::scrollback::{
