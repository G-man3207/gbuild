...
gBuild knows its own capabilities and can configure itself. Try:
...
## Teach gBuild your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. gBuild reads it automatically in every session — it's the single
...
## Teach gBuild your facts: memory
