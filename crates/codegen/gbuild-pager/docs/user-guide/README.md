...
Automate, script, and integrate gBuild with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `gbuild -p`, output formats, CI/CD integration, and piping |
