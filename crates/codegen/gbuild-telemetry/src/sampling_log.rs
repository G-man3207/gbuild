//! Tracing layer for `target: "sampling_log"` → `~/.gbuild/logs/sampling.jsonl`.
//! Enable with `--log-sampling` or `GBUILD_LOG_SAMPLING=1`.
...
const ENV_VAR: &str = "GBUILD_LOG_SAMPLING";
