...
/// The base prompt template source, exposed for `gbuild prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `gbuild prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard gbuild tool kinds.
