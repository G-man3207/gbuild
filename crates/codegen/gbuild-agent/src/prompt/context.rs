...
pub struct PromptContext {
    ...
    /// Identity in the primary gbuild system prompt (`You are <label>…`).
...
mod tests {
    ...
    fn test_agents_md_paths_use_display_cwd_in_rendered_section() {
        ...
        let overlay_path = "/root/.gbuild/worktrees/my-project/ab-123-a-overlay";
    ...
    fn trimmed_prompts_no_redundant_identity() {
        ...
        for (name, prompt) in [
            ...
            assert!(
                !prompt.contains("You are a gBuild agent"),
