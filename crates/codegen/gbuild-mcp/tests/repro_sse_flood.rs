...
//!
//! Run with: cargo test -p gbuild-mcp --test repro_sse_flood -- --nocapture
...
use gbuild_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use gbuild_mcp::rmcp::ServiceExt;
use gbuild_mcp::rmcp::transport::StreamableHttpClientTransport;
use gbuild_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
