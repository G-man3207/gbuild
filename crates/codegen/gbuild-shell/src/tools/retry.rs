//! Retry utilities — re-exported from `gbuild-tools`.
//!
//! The canonical implementation now lives in `gbuild_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use gbuild_tools::retry::BackoffConfig as RetryConfig;
pub use gbuild_tools::retry::{BackoffConfig, execute_with_backoff};
