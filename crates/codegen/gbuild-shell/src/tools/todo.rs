//! Todo types — re-exported from `gbuild-tools` with ACP conversion helpers.
//!
//! Types are canonical in `gbuild-tools`. This module adds ACP ↔ TodoItem
//! conversions since `gbuild-tools` is protocol-agnostic.

pub use gbuild_tools::implementations::gbuild::todo::TodoId;
pub use gbuild_tools::implementations::gbuild::todo::TodoItem;
pub use gbuild_tools::implementations::gbuild::todo::TodoPriority;
pub use gbuild_tools::implementations::gbuild::todo::TodoState;
pub use gbuild_tools::implementations::gbuild::todo::TodoStatus;
