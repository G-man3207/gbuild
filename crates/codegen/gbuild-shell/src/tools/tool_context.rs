...
//! gbuild-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use gbuild_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use gbuild_workspace::session::file_state::FileStateHandle;
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> gbuild_tools::implementations::gbuild::task::types::SubagentForegroundWait {
    gbuild_tools::implementations::gbuild::task::types::SubagentForegroundWait::new(move || {
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn gbuild_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<gbuild_tools::implementations::gbuild::task::types::MonitorEventBuffer>,
