//! Heap-profile IoC seam (local jemalloc dumps only).
//!
//! The composition root installs jemalloc ops; without a hook (tests, Windows,
//! non-jemalloc builds) every seam API is inert. The xAI heap-dump upload
//! monitor has been removed from this fork.
