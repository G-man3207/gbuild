...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "GBUILD_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "GBUILD_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`GBUILD_MIN_DRAW_MS` / `GBUILD_SCROLL_CADENCE_MS`).
