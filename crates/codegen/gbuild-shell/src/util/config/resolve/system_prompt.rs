pub const ENV_SYSTEM_PROMPT_LABEL: &str = "GBUILD_SYSTEM_PROMPT_LABEL";

pub const DEFAULT_SYSTEM_PROMPT_LABEL: &str = gbuild_agent::DEFAULT_SYSTEM_PROMPT_LABEL;
...
mod system_prompt_label_tests {
    ...
    /// Serialize access to `GBUILD_SYSTEM_PROMPT_LABEL` and clear it for tier tests.
