...
pub fn loaded_plugin_to_info(plugin: &gbuild_agent::plugins::LoadedPlugin) -> PluginInfo {
    use gbuild_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &gbuild_agent::plugins::PluginOrigin) -> PluginOrigin {
    use gbuild_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
        AgentOrigin::CliOverride => PluginOrigin::CliOverride,
        AgentOrigin::ProjectGBuild => PluginOrigin::ProjectGBuild,
        AgentOrigin::ProjectClaude => PluginOrigin::ProjectClaude,
        AgentOrigin::UserGBuild => PluginOrigin::UserGBuild,
...
mod tests {
    use super::*;
    use gbuild_agent::plugins::PluginOrigin as AgentOrigin;
    use gbuild_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> gbuild_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        gbuild_agent::plugins::LoadedPlugin {
