...
impl WorktreeNotificationSender for GatewayWorktreeNotifier {
    async fn send_worktree_status(&self, progress: WorktreeStatus) {
        ...
        let notification = acp::ExtNotification::new("gbuild/git/worktree/status", params.into());
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "gbuild/git/worktree/create_from_worktree" => {
            let mut req =
            ...
            let result = ops
                .dispatch(
                    &gbuild_workspace::workspace_ops::PrepareWorktreeFromWorktreeReq {
                        inner: req.clone(),
                    },
                    None,
                )
        ...
        "gbuild/git/worktree/create_from_worktree_sync" => {
            ...
            let resolved_root = ops
                .dispatch(
                    &gbuild_workspace::workspace_ops::GitResolveRootReq {
            ...
            if let Some(git_root) = resolved_root {
                let vcs_kind = ops
                    .dispatch(
                        &gbuild_workspace::workspace_ops::DetectVcsKindReq {
                            path: git_root.clone(),
                        },
                        None,
                    )
                    .await
                    .unwrap_or(gbuild_workspace::session::git::VcsKind::Git);
                if vcs_kind.is_jj() {
            ...
            let result = ops
                .dispatch(
                    &gbuild_workspace::workspace_ops::CreateWorktreeFromWorktreeSyncReq {
                        inner: req.into_wire(),
                    },
                    None,
                )
        ...
        "gbuild/git/worktree/resume_session" => {
            ...
            let agent_id = gbuild_telemetry::id::agent_id();
        ...
        "gbuild/git/worktree/list" => {
            let req: gbuild_workspace::workspace_ops::WorktreeListReq =
        ...
        "gbuild/git/worktree/show" => {
            ...
            let op = gbuild_workspace::workspace_ops::WorktreeShowReq {
        ...
        "gbuild/git/worktree/gc" => {
            ...
            let op = gbuild_workspace::workspace_ops::WorktreeGcReq {
                dry_run: req.dry_run,
                max_age_secs,
                force: req.force,
            };
        ...
        "gbuild/git/worktree/db/stats" => {
            let result = ops
                .dispatch(
                    &gbuild_workspace::workspace_ops::WorktreeDbStatsReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "gbuild/git/worktree/db/rebuild" => {
            let result = ops
                .dispatch(
                    &gbuild_workspace::workspace_ops::WorktreeDbRebuildReq {},
                    None,
                )
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
        ...
        "gbuild/git/worktree/db/path" => {
            let result = ops
                .dispatch(&gbuild_workspace::workspace_ops::WorktreeDbPathReq {}, None)
                .await
                .map_err(|e| acp::Error::internal_error().data(e.to_string()))?;
            to_response(Ok(result))
        }
...
mod tests {
    ...
    fn db_path_response_serializes() {
        let resp = WorktreeDbPathResponse {
            path: "/home/user/.gbuild/worktrees.db".into(),
        };
        let json = serde_json::to_string(&resp).unwrap();
        assert!(json.contains("\"path\":\"/home/user/.gbuild/worktrees.db\""));
    }
