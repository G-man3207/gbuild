...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "gbuild/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
        ...
        "gbuild/hunk-tracker/get-summary" => {
        ...
        // Single Hunk Action
        // ───────────────────────────────────────────────────────────────
        "gbuild/hunk-tracker/hunk-action" => {
        ...
        // Bulk Actions
        // ───────────────────────────────────────────────────────────────
        "gbuild/hunk-tracker/file-action" => {
        ...
        "gbuild/hunk-tracker/turn-action" => {
        ...
        "gbuild/hunk-tracker/all-action" => {
