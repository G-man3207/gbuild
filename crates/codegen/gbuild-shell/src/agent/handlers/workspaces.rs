...
mod tests {
    ...
    #[test]
    fn success_response_projects_gbuild_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["gbuild/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["gbuild/partial"]["reason"], "no_oauth");
    }
}
