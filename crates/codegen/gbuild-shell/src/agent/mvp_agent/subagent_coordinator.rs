...
//! The shared coordinator actor lives in `gbuild-tools`; this module plugs
...
impl gbuild_tools::implementations::gbuild::task::coordinator::ChildRunner
    for ShellChildRunner
{
    ...
    type RunFuture = gbuild_tools::implementations::gbuild::task::coordinator::LocalBoxFuture<
        gbuild_tools::implementations::gbuild::task::coordinator::ChildRunOutput<
            Self::CompletionData,
        >,
    >;
    type ValidateFuture =
        gbuild_tools::implementations::gbuild::task::coordinator::LocalBoxFuture<
            gbuild_tools::implementations::gbuild::task::types::SubagentValidateTypeOutcome,
        >;
    type DescribeFuture =
        gbuild_tools::implementations::gbuild::task::coordinator::LocalBoxFuture<
            gbuild_tools::implementations::gbuild::task::types::SubagentDescribeOutcome,
        >;
    fn run(
        &self,
        run: gbuild_tools::implementations::gbuild::task::coordinator::ChildRunRequest<
            Self::Control,
        >,
    ) -> Self::RunFuture {
        let agent_ref = self.agent_ref.clone();
        Box::pin(async move {
            let gbuild_tools::implementations::gbuild::task::coordinator::ChildRunRequest {
                request,
                cancellation,
                reporter,
            } = run;
            ...
            let Some(mut ctx) = this.try_build_subagent_spawn_context(&parent_sid) else {
                ...
                return gbuild_tools::implementations::gbuild::task::coordinator::ChildRunOutput {
                    result: gbuild_tools::implementations::gbuild::task::types::SubagentResult {
                        success: false,
                        error: Some(
        ...
        Box::pin(async move {
            ...
            match this.try_build_subagent_spawn_context(&parent_session_id) {
                ...
                None => {
                    ...
                    gbuild_tools::implementations::gbuild::task::types::SubagentDescribeOutcome::Unavailable
                }
            }
        })
    }
    fn on_completed(
        &self,
        completion: gbuild_tools::implementations::gbuild::task::coordinator::ChildCompletion<
            Self::CompletionData,
        >,
    ) {
...
impl MvpAgent {
    ...
    /// [`SubagentCoordinator`](gbuild_tools::implementations::gbuild::task::coordinator::SubagentCoordinator)
    ...
    pub(super) fn start_subagent_coordinator(&self) {
        ...
        let config =
            gbuild_tools::implementations::gbuild::task::coordinator::CoordinatorConfig {
                foreground_budget:
                    gbuild_tools::implementations::gbuild::task::backend::env_duration_or(
                        "GBUILD_SUBAGENT_AWAIT_BUDGET_MS",
        ...
        tokio::task::spawn_local(
            gbuild_tools::implementations::gbuild::task::coordinator::SubagentCoordinator::new(
                    rx,
                    runner,
                    config,
                )
                ...
                ps.map(|h| h.tool_context.fs.inner().clone())
                    .unwrap_or_else(|| {
                        let cwd = ps
                            ...
                            .unwrap_or_default();
                        std::sync::Arc::new(gbuild_workspace::file_system::LocalFs::new(cwd))
                    }),
        ...
        Some(crate::agent::subagent::SubagentSpawnContext {
            ...
            task_output_tool_name: {
                ...
                sessions
                    ...
                    .unwrap_or_else(|| {
                        gbuild_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
                            .to_string()
                    })
            },
