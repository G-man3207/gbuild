...
) -> Option<gbuild_sampling_types::PriorTurnInterrupt> {
    use gbuild_sampling_types::PriorTurnInterrupt;
    match category {
...
/// committing it would silently run gBuild flavor. Distinct from
