...
pub(crate) struct WorkflowManager {
    ...
    subagent_event_tx:
        mpsc::UnboundedSender<gbuild_tools::implementations::gbuild::task::types::SubagentEvent>,
...
impl WorkflowManager {
    ...
    fn cancel_children_for_run(&self, run_id: &str) -> bool {
        ...
        self.subagent_event_tx
            .send(
                gbuild_tools::implementations::gbuild::task::types::SubagentEvent::Cancel(
                    gbuild_tools::implementations::gbuild::task::types::SubagentCancelRequest {
                        parent_session_id: Some(self.session_id.clone()),
                        target: gbuild_tools::implementations::gbuild::task::types::SubagentCancelTarget::WorkflowRunId(
                            run_id.to_owned(),
                        ),
                        respond_to,
                    },
...
mod tests {
    ...
    type SubagentEventRx =
        mpsc::UnboundedReceiver<gbuild_tools::implementations::gbuild::task::types::SubagentEvent>;
    type CancelLog = Arc<
        parking_lot::Mutex<
            Vec<gbuild_tools::implementations::gbuild::task::types::SubagentCancelTarget>,
        >,
    >;
    ...
    async fn pause_marks_user_paused_and_resume_replays() {
        ...
        use gbuild_tools::implementations::gbuild::task::types::SubagentEvent;
        ...
        use gbuild_tools::implementations::gbuild::task::types::SubagentResult;
    ...
    async fn workflow_spawns_await_to_completion() {
        ...
        assert_eq!(
            ...
            gbuild_tools::implementations::gbuild::task::types::ModelOverrideProvenance::Tool,
