...
//! `crate::session::prompt_queue::*` and cross-crate `gbuild_shell::session::prompt_queue::*`
...
pub const QUEUE_CHANGED_METHOD: &str = "gbuild/queue/changed";
    ...
    fn queue_changed_serializes_camel_case_with_session_id() {
        let payload = QueueChanged {
            ...
            entries: vec![QueueEntryWire {
                id: "p1".to_string(),
                version: 0,
                owner: Some("gbuild-tui".to_string()),
                last_editor: None,
