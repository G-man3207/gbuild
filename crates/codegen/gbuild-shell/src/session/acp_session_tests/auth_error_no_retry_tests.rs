...
/// attribution.
fn auth_error() -> gbuild_sampler::SamplingErrorInfo {
    gbuild_sampler::SamplingErrorInfo {
        kind: gbuild_sampler::SamplingErrorKind::Auth,
...
fn model_not_found_error() -> gbuild_sampler::SamplingErrorInfo {
    gbuild_sampler::SamplingErrorInfo {
    ...
    local
        .run_until(async {
            ...
            assert!(
                ...
                "hint must mention `gbuild logout`, got: {msg}"
            );
            assert!(
...
fn unauthorized_401_error() -> gbuild_sampler::SamplingErrorInfo {
    gbuild_sampler::SamplingErrorInfo {
            kind: gbuild_sampler::SamplingErrorKind::Api,
...
async fn sampler_non_auth_kind_401_on_provider_model_still_recovers() {
    ...
    local
        .run_until(async {
            ...
            error.kind = gbuild_sampler::SamplingErrorKind::Api;
