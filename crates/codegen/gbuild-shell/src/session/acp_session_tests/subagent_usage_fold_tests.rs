...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use gbuild_tools::implementations::gbuild::task::types::SubagentOutstandingReply;
...
fn scripted_outstanding_responder(
    replies: Vec<gbuild_tools::implementations::gbuild::task::types::SubagentOutstandingReply>,
