...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<gbuild_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(gbuild_tools::implementations::gbuild::update_goal::UpdateGoalInput),
    Channel(gbuild_tools::implementations::gbuild::update_goal::UpdateGoalEnvelope),
}
