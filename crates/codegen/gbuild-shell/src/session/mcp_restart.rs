...
//! window containing a [`gbuild_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`gbuild_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`gbuild_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`gbuild_mcp::servers::ClientStateKind::Empty`]
...
use gbuild_mcp::servers::{McpClientEventKind, McpServerName};
