...
pub enum SessionCommand {
    ...
    RestorePlanApproval,
    GetToolOverrides {
        respond_to: oneshot::Sender<Option<gbuild_sampling_types::ToolOverrides>>,
    },
    ...
    SetToolOverrides {
        overrides: gbuild_sampling_types::ToolOverrides,
    },
    Prompt {
        prompt_id: String,
        ...
        tool_overrides_update: Option<gbuild_sampling_types::ToolOverridesUpdate>,
    ...
    SetSessionModel {
        sampling_config: gbuild_sampler::SamplerConfig,
        use_concise: bool,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<gbuild_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<gbuild_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<gbuild_tools::types::TaskSnapshot>>>,
    },
    ...
    PluginsList {
        respond_to: oneshot::Sender<Option<std::sync::Arc<gbuild_agent::plugins::PluginRegistry>>>,
    },
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<gbuild_sampling_types::conversation::ConversationItem>>>,
    },
