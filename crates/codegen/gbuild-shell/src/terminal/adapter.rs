//! `AcpTerminalAdapter`: implements `gbuild-tools::TerminalBackend` over ACP
...
use gbuild_tools::computer::types::{
...
/// Wraps gbuild-shell's ACP gateway to satisfy gbuild-tools' TerminalBackend.
