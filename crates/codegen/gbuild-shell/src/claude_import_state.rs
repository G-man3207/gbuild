...
//
// State is persisted to `~/.gbuild/claude_import_state.json`.
...
use gbuild_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.gbuild/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::gbuild_home::gbuild_home().join("claude_import_state.json")
}
