...
use gbuild_shell::auth::{AuthManager, AuthMode, GrokAuth, GrokComConfig};
use gbuild_shell::heap_profile::{
...
use gbuild_test_support::{EnvGuard, MockInferenceServer};
use gbuild_version::TEST_VERSION_ENV;
...
fn assert_storage_auth(uploads: &[gbuild_test_support::mock_server::StorageUpload]) {
    for u in uploads {
        assert_eq!(
