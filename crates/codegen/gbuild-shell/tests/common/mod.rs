//! Shared helpers for gbuild-shell integration tests.

use gbuild_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use gbuild_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `gbuild_sampler::SamplingClient`, which takes a
