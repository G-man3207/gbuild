...
use gbuild_shell::extensions::notification::{
    DiffContent, SessionNotification, SessionUpdate as XaiSessionUpdate,
};
use gbuild_shell::session::info::Info as SessionInfo;
use gbuild_shell::session::persistence::default_model_id;
use gbuild_shell::session::storage::{JsonlStorageAdapter, SessionUpdate, StorageAdapter};
