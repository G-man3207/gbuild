//! AcpFsAdapter: implements `gbuild-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates gbuild-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use gbuild_tools::computer::types::{AsyncFileSystem, ComputerError};
use xai_acp_lib::AcpAgentGatewaySender as GatewaySender;

/// Wraps gbuild-shell's ACP gateway to satisfy gbuild-tools' AsyncFileSystem.
///
