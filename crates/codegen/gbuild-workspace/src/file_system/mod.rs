...
// its wire types live in `gbuild_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use gbuild_workspace_types::rpc::fs::FsReadEncoding;
...
pub use gbuild_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
