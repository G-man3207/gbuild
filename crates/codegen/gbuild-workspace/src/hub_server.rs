...
use gbuild_tools::implementations::gbuild::scheduler::interval::interval_to_human;
use gbuild_tools::implementations::gbuild::scheduler::types::{SchedulerCommand, SchedulerHandle};
use gbuild_tools::registry::types::FinalizedToolset;
use gbuild_tools::types::resources::Terminal;
use gbuild_workspace_types::rpc::workspace::{
...
static WORKSPACE_RPC_CALLER_MISMATCH_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "gbuild_workspace_rpc_caller_mismatch_total",
...
static WORKSPACE_RPC_MUTATION_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "gbuild_workspace_rpc_mutation_total",
...
static WORKSPACE_RPC_REQUESTS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "gbuild_workspace_rpc_requests_total",
...
static WORKSPACE_RPC_ERRORS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "gbuild_workspace_rpc_errors_total",
...
static WORKSPACE_RPC_DURATION_SECONDS: std::sync::LazyLock<HistogramVec> =
    std::sync::LazyLock::new(|| {
        register_histogram_vec!(
            "gbuild_workspace_rpc_duration_seconds",
...
) -> Vec<gbuild_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use gbuild_tools::computer::types::TaskKind;
    use gbuild_tools::types::resources::Terminal;
    use gbuild_tools::types::tool::ToolKind;
    use gbuild_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &gbuild_tools::registry::types::FinalizedToolset,
) -> Vec<gbuild_workspace_types::rpc::workspace::TodoSummaryWire> {
    use gbuild_tools::implementations::gbuild::todo::{TodoState, TodoStatus};
    use gbuild_tools::types::resources::State;
    use gbuild_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use gbuild_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use gbuild_workspace_types::rpc::search::FuzzyStatusReq;
        use gbuild_workspace_types::rpc::skills::DiscoverPluginsReq;
        use gbuild_workspace_types::rpc::workspace::{
        ...
        use gbuild_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
...
mod tests {
    ...
    use gbuild_tools::implementations::gbuild::scheduler::types::{ScheduledTask, SchedulerState};
    use gbuild_tools::types::resources::State;
    use xai_tool_protocol::turn_hook;
    ...
    async fn list_background_tasks_rpc_stays_truthful_across_rebinds() {
        ...
        use gbuild_workspace_types::rpc::workspace::ListBackgroundTasksResponse;
        let handle = make_handle();
        ...
        let read_only = ToolServerConfig {
            tools: vec![tc(
                "GBuild:read_file",
                Some(gbuild_tools::types::tool::ToolKind::Read),
            )],
    ...
    async fn handle_call_records_rpc_metrics_and_collapses_unknown_method() {
        ...
        let has_bogus_series = prometheus::gather()
            .iter()
            .filter(|mf| mf.name() == "gbuild_workspace_rpc_requests_total")
