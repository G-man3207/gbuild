...
use gbuild_tools::types::output::ToolRunResult;
use gbuild_workspace_client::{WorkspaceClient, is_transport_fatal};
pub use gbuild_workspace_types::rpc::WorkspaceRpc;
pub use gbuild_workspace_types::rpc::agents_md::DiscoverAgentsMdReq;
pub use gbuild_workspace_types::rpc::code_nav::{
...
pub use gbuild_workspace_types::rpc::export_github::ExportGithubReq;
pub use gbuild_workspace_types::rpc::fs::{
...
pub use gbuild_workspace_types::rpc::git::{
...
pub use gbuild_workspace_types::rpc::hooks::{
    HookEventNameWire, HookRegistryReq, HookRegistryWire, HookSpecWire,
};
pub use gbuild_workspace_types::rpc::hunks::{
...
pub use gbuild_workspace_types::rpc::search::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
pub use gbuild_workspace_types::rpc::session::{BeginPromptReq, EndPromptReq, RewindToReq};
pub use gbuild_workspace_types::rpc::skills::DiscoverSkillsReq;
pub use gbuild_workspace_types::rpc::workspace::WorkspaceInfoReq;
...
fn hook_registry_to_wire(
    registry: &gbuild_hooks::discovery::HookRegistry,
...
fn wire_to_hook_registry(
...
) -> WorkspaceResult<gbuild_hooks::discovery::HookRegistry> {
    ...
    let mut registry: gbuild_hooks::discovery::HookRegistry =
        serde_json::from_value(value).map_err(|e| WorkspaceError::HubError(e.to_string()))?;
...
///   session's [`FinalizedToolset`](gbuild_tools::registry::types::FinalizedToolset).
...
impl WorkspaceOps {
    ...
    pub async fn hook_registry(&self) -> WorkspaceResult<gbuild_hooks::discovery::HookRegistry> {
    ...
    ///   [`FinalizedToolset`](gbuild_tools::registry::types::FinalizedToolset)
...
mod tests {
    ...
    /// request types are defined in `gbuild-workspace-types` (and re-exported
    ...
    fn hook_registry_wire_round_trip_both_directions() {
        let spec = gbuild_hooks::config::HookSpec {
            ...
            event: gbuild_hooks::event::HookEventName::PreToolUse,
            ...
            url_raw: None,
            timeout_ms: 5000,
            source_dir: std::path::PathBuf::from("/home/u/.gbuild/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
            layer: gbuild_hooks::config::HookProvenance::File,
        };
        let mut registry = gbuild_hooks::discovery::HookRegistry::default();
    ...
    fn hook_event_name_wire_covers_all_upstream_variants() {
        use gbuild_hooks::event::HookEventName as E;
    ...
    /// can't depend on `gbuild-hooks`, and `hook_registry_to_wire` only couples
    ...
    fn hook_spec_wire_covers_all_upstream_fields() {
        use gbuild_hooks::config::HookSpec;
        ...
        let spec = HookSpec {
            ...
            source_dir: std::path::PathBuf::from("/home/u/.gbuild/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
            layer: gbuild_hooks::config::HookProvenance::Managed,
        };
        assert_eq!(
