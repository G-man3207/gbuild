...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `gbuild-workspace` crate that produced the record.
    ...
    /// Sandbox profile name (`$GBUILD_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("GBUILD_SANDBOX_PROFILE").ok(),
