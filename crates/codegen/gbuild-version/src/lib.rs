//! Installed gBuild CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "GBUILD_TEST_VERSION";

pub const VERSION: &str = match option_env!("GBUILD_VERSION") {
    Some(v) => v,
