//! ToolBridge: adapter that wraps `gbuild-tools`'s `ToolRegistry` and
...
impl ToolBridge {
    ...
    /// `Some("get_task_output")` for the gbuild agent and `None` for
    ...
    pub async fn list_scheduled_tasks(
        &self,
    ) -> Vec<crate::implementations::gbuild::scheduler::types::ScheduledTask> {
        use crate::implementations::gbuild::scheduler::types::{SchedulerCommand, SchedulerHandle};
        let sender = {
    ...
    pub async fn delete_scheduled_task(
        ...
        reply_rx
            ...
            .map_err(crate::implementations::gbuild::scheduler::types::scheduler_tool_error)
    }
...
mod tests {
    ...
    fn tool_kind_returns_registered_kind_per_namespace_and_none_for_unknown() {
        ...
        // PascalCase + gbuild's snake_case in one registry
