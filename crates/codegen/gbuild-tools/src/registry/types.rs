use crate::{
    ...
    implementations::{
        codex, gbuild, gbuild_concise, gbuild_hashline, opencode, skills::types::SkillInfo,
    },
...
/// this crate: instead of `gbuild-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
pub struct SubagentSessionResources {
    pub backend: crate::implementations::gbuild::task::backend::SubagentBackendResource,
    ...
    pub event_sender: crate::implementations::gbuild::task::types::SubagentEventSender,
    pub depth: crate::implementations::gbuild::task::types::SubagentDepthCounter,
    pub session_id: crate::implementations::gbuild::task::types::SessionIdResource,
}
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::gbuild::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::gbuild::web_fetch::WebFetchConfig,
    ...
    pub image_gen_config: crate::implementations::gbuild::image_gen::ImageGenConfig,
    ...
    pub video_gen_config: crate::implementations::gbuild::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::gbuild::deploy_app::AppBuilderDeployerConfig,
...
impl ToolRegistryBuilder {
    ...
    /// Fully-qualified tool id (`"GBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<gbuild::BashTool, gbuild::bash::BashParams>();
        b.register_with_params::<gbuild::ReadFileTool, gbuild::read_file::ReadFileParams>();
        b.register_with_params::<
                gbuild::SearchReplaceTool,
                gbuild::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<gbuild::ListDirTool, gbuild::list_dir::ListDirParams>();
        b.register_with_params::<gbuild::GrepTool, gbuild::grep::GrepParams>();
        b.register::<gbuild::KillTaskTool>();
        b.register::<gbuild::KillTerminalCommandTool>();
        b.register::<gbuild::TodoWriteTool>();
        b.register::<gbuild::UpdateGoalTool>();
        b.register::<gbuild::WorkflowTool>();
        b.register::<gbuild::TaskOutputTool>();
        b.register::<gbuild::GetTerminalCommandOutputTool>();
        b.register::<gbuild::WaitTasksTool>();
        b.register::<gbuild::TaskTool>();
        b.register::<gbuild::WebSearchTool>();
        b.register_with_params::<gbuild::WebFetchTool, gbuild::web_fetch::WebFetchParams>();
        b.register::<gbuild::LspTool>();
        b.register::<gbuild::ImageGenTool>();
        b.register::<gbuild::ImageEditTool>();
        b.register::<gbuild::ImageToVideoTool>();
        b.register::<gbuild::ReferenceToVideoTool>();
        b.register::<gbuild::EnterPlanModeTool>();
        b.register::<gbuild::ExitPlanModeTool>();
        b.register_with_params::<
                gbuild::AskUserQuestionTool,
                gbuild::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<gbuild::MonitorTool>();
        b.register::<gbuild::SchedulerCreateTool>();
        b.register::<gbuild::SchedulerDeleteTool>();
        b.register::<gbuild::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                gbuild_concise::ReadFileConciseTool,
                gbuild::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                gbuild_concise::SearchReplaceConciseTool,
                gbuild::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<gbuild_concise::BashConciseTool, gbuild::bash::BashParams>();
        b.register_with_params::<
                gbuild_hashline::HashlineReadTool,
                gbuild_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                gbuild_hashline::HashlineEditTool,
                gbuild_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                gbuild_hashline::HashlineGrepTool,
                gbuild_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            let standard_file_ids: &[&str] =
                &["GBuild:read_file", "GBuild:search_replace", "GBuild:grep"];
            let hashline_file_ids: &[&str] = &[
                "GBuildHashline:hashline_read",
                "GBuildHashline:hashline_edit",
                "GBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if image_gen_config.has_credentials() {
            match crate::implementations::gbuild::image_gen::ImageGenClient::new(
                &image_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if video_gen_config.is_enabled() {
            match crate::implementations::gbuild::video_gen::VideoGenClient::new(
                &video_gen_config,
                ctx.api_key_provider.clone(),
            ) {
                Ok(client) => {
        ...
        if let crate::implementations::gbuild::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::gbuild::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::GBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::gbuild::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::gbuild::scheduler::types::SchedulerState>();
            ...
            ctx.parent_scheduler_handle
        {
            ...
            resources.insert(
                crate::implementations::gbuild::scheduler::types::SchedulerHandle(scheduler_cmd_tx),
            );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::gbuild::scheduler::actor::SchedulerActor {
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "GBuild:get_task_output" => {
            let has_gbuild_bash = has_tool_with_bool_param(
                proposed,
                "GBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_gbuild_concise_bash = has_tool_with_bool_param(
                proposed,
                "GBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "GBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "GBuild", "run_terminal_cmd")
                && !has_gbuild_bash
            {
                notes
                    .push(
                        "GBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "GBuildConcise", "run_terminal_cmd")
                && !has_gbuild_concise_bash
            {
                notes
                    .push(
                        "GBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (GBuild:run_terminal_cmd or GBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or GBuild:task"
                .to_string();
            let has_provider = has_gbuild_bash || has_gbuild_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or GBuild:task",
                )
                .with_category("requirements")
        }
        "GBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as GBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "GBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires GBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include GBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "GBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires GBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include GBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config: crate::implementations::gbuild::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config: crate::implementations::gbuild::image_gen::ImageGenConfig::default(),
            video_gen_config: crate::implementations::gbuild::video_gen::VideoGenConfig::default(),
            app_builder_deployer_config:
                crate::implementations::gbuild::deploy_app::AppBuilderDeployerConfig::default(),
    ...
    /// appeared before `gbuild:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "GBuild:search_replace".to_string(),
                    params: Some(
    ...
    /// Smoke test: finalize the full GBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::gbuild::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("GBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (gBuild).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let gbuild = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("GBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("GBuild:get_task_output".to_string()),
                        ToolConfig::from_id("GBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("gBuild toolset should finalize");
        assert_eq!(
            gbuild.tool_name_for_kind(ToolKind::Execute).as_deref(),
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({"id": "GBuild:read_file", "kind": "read"}));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({"id": "GBuild:read_file", "kind": "raed"}));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({"id": "GBuild:read_file"}));
    ...
    /// Verify GBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "GBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "GBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "GBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<gbuild::GrepTool>(),
                ToolConfig::for_tool::<gbuild::KillTaskTool>(),
                ToolConfig::for_tool::<gbuild::TaskOutputTool>(),
                ToolConfig {
                    id: "GBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        let builder = ToolRegistryBuilder::new();
        for id in [
            "GBuild:run_terminal_cmd",
            "GBuild:read_file",
            "GBuild:search_replace",
            "GBuild:list_dir",
            "GBuild:grep",
            "GBuild:get_terminal_command_output",
            "GBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("GBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("GBuild:run_terminal_cmd", ToolKind::Execute),
            ("GBuild:read_file", ToolKind::Read),
            ("GBuild:search_replace", ToolKind::Edit),
            ("GBuild:grep", ToolKind::Search),
            ("GBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("GBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `GBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "GBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "GBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "GBuildHashline:hashline_read".to_string(),
                params: Some(
                    serde_json::from_value(serde_json::json!({
                        "hash_len": 0
                    }))
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<gbuild::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<gbuild::ReadFileTool>(),
                ToolConfig::for_tool::<gbuild::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        assert!(
            errors.iter().any(|e| e.tool == "GBuild:task"
                && e.message.contains("GBuild:get_task_output")
                && e.message.contains("GBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "GBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "GBuild:task" && e.message.contains("GBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "GBuild:task" && e.message.contains("GBuild:get_task_output")),
    ...
    /// gBuild agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("GBuild:run_terminal_cmd"),
                tool("GBuild:task"),
                tool("GBuild:get_task_output"),
                tool("GBuild:wait_tasks"),
                tool("GBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("GBuild:get_task_output"));
        assert!(error.message.contains("GBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "GBuild:task");
        assert!(error.message.contains("GBuild:get_task_output"));
        assert!(error.message.contains("GBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "GBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "GBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "GBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default gBuild tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        let builder = ToolRegistryBuilder::new();
        assert!(
            builder.tools.contains_key("GBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder.tools.contains_key("GBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder.tools.contains_key("GBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("GBuildHashline:hashline_read"),
                hashline_tool_config("GBuildHashline:hashline_edit"),
                hashline_tool_config("GBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("GBuild:read_file"),
                hashline_tool_config("GBuild:search_replace"),
                hashline_tool_config("GBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<gbuild::EnterPlanModeTool>(),
                ToolConfig::for_tool::<gbuild::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "GBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<gbuild_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<gbuild_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<gbuild::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "GBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background": true })
                    .as_object()
                    .unwrap()
    ...
    async fn gbuild_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<gbuild::ListDirTool>(),
                ToolConfig::for_tool::<gbuild::ReadFileTool>(),
                ToolConfig::for_tool::<gbuild::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<gbuild::TaskOutputTool>(),
                ToolConfig::for_tool::<gbuild::KillTaskTool>(),
                ToolConfig::for_tool::<gbuild::GrepTool>(),
                ToolConfig::for_tool::<gbuild::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = gbuild_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = gbuild_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<gbuild::ListDirTool>()],
            behavior_preset: None,
        };
    ...
    fn generate_schema_strips_root_title_and_description() {
        let schema = generate_schema::<crate::implementations::gbuild::bash::BashToolInput>();
        assert!(
