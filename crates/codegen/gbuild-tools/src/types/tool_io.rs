...
use crate::implementations::gbuild::ask_user_question::AskUserQuestionInput;
use crate::implementations::gbuild::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::gbuild::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::gbuild::grep::GrepSearchInput;
use crate::implementations::gbuild::image_edit::ImageEditInput;
use crate::implementations::gbuild::image_gen::ImageGenInput;
use crate::implementations::gbuild::list_dir::ListDirInput;
use crate::implementations::gbuild::read_file::ReadFileInput;
use crate::implementations::gbuild::search_replace::SearchReplaceInput;
use crate::implementations::gbuild::todo::TodoWriteInput;
use crate::implementations::gbuild::update_goal::UpdateGoalInput;
use crate::implementations::gbuild::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::gbuild::web_fetch::WebFetchInput;
use crate::implementations::gbuild::web_search::WebSearchInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::gbuild_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::gbuild::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::gbuild::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::gbuild::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::gbuild::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::gbuild::workflow::WorkflowToolInput),
