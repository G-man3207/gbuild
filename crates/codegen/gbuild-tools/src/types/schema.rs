...
///
/// Use with `#[schemars(with = "GBuildIntegerSchema")]` on `Option<usize>` fields.
pub struct GBuildIntegerSchema;
impl schemars::JsonSchema for GBuildIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "gbuild_integer_schema".into()
    }
