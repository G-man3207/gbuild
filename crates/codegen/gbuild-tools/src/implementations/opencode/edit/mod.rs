...
use crate::implementations::gbuild::search_replace::CONTEXT_LINES;
use crate::implementations::gbuild::search_replace::helpers::{
...
// the snake_case `params.edit.old_string` keys of the gbuild twin resolve
...
// are imported from `gbuild::search_replace::helpers` — shared across
// both the gbuild and opencode edit tools.
