...
use crate::implementations::gbuild::grep::ripgrep::rg_path;
...
///
/// Shares `ToolKind::Search` with the gBuild `GrepTool`. These tools are
/// namespace-exclusive — consumers enable either `GBuild` or `Codex` search,
