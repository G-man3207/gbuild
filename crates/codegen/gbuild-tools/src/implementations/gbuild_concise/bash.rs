...
use crate::implementations::gbuild::bash::{BashTool, BashToolInput, BashToolOutput, KillReason};
...
mod tests {
    ...
    fn no_double_header_after_default_prebake() {
        ...
        bash.output_for_prompt = crate::implementations::gbuild::bash::format_default_prompt(
