...
//!
//! Reuses the core file-reading logic from [`gbuild::read_file::run_read_file`]
...
use crate::implementations::gbuild::read_file::{ReadFileInput, run_read_file};
...
mod tests {
    ...
    use crate::implementations::gbuild::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    /// file content independently of gbuild `read_file`).
    #[tokio::test]
