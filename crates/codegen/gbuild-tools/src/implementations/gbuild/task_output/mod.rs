...
use crate::implementations::gbuild::task::TaskTool;
use crate::implementations::gbuild::task::backend::SubagentBackendResource;
use crate::implementations::gbuild::task::types::{SubagentSnapshot, SubagentSnapshotStatus};
use crate::implementations::gbuild_concise::BashConciseTool;
...
/// `TaskOutput` cap. Env override: `GBUILD_MAX_WAIT_BLOCK_MS`.
const MAX_WAIT_BLOCK: Duration = Duration::from_secs(600);

fn max_wait_block() -> Duration {
    std::env::var("GBUILD_MAX_WAIT_BLOCK_MS")
        .ok()
...
pub(crate) fn background_bash_requires_exprs() -> Vec<Expr<ToolRequirement>> {
    ...
    let gbuild_bash = Expr::Value(ToolRequirement::Tool {
    ...
    let gbuild_concise_bash = Expr::Value(ToolRequirement::Tool {
    ...
    vec![gbuild_bash, gbuild_concise_bash, opencode_bash]
}
...
impl crate::types::tool_metadata::ToolMetadata for TaskOutputTool {
    ...
    fn description_template(&self) -> &str {
        ...
        // fallback mirrors the default gBuild toolset.
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        // The static fallback is the shared builder's default gBuild
    ...
    fn resources_with_backend_query() -> (
        ...
        tokio::sync::mpsc::UnboundedReceiver<
            crate::implementations::gbuild::task::types::SubagentEvent,
        >,
    ) {
        use crate::implementations::gbuild::task::backend::{
            ChannelBackend, SubagentBackendResource,
        };
        use crate::implementations::gbuild::task::types::SubagentEvent;
    ...
    fn unwrap_query(
        event: crate::implementations::gbuild::task::types::SubagentEvent,
    ) -> crate::implementations::gbuild::task::types::SubagentQueryRequest {
        match event {
            crate::implementations::gbuild::task::types::SubagentEvent::Query(q) => q,
