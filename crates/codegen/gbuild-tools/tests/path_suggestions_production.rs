...
//! Run:
//! ```bash
//! cargo test -p gbuild-tools --test path_suggestions_production
//! ```

use gbuild_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &gbuild_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_gbuild_sessions_internal_path() {
