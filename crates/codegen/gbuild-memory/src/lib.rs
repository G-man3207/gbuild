...
//! gBuild to persist important information across sessions. Memory files are
//! stored under `~/.gbuild/memory/` with workspace-scoped subdirectories
...
//! `GBUILD_MEMORY=1` environment variable. When disabled, this crate
