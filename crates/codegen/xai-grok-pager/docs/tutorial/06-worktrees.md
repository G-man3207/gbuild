...
Want gBuild working on a feature while you (or another gBuild session) work on
...
- **From the shell:**
  ...
  ```bash
  gbuild --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three gBuild sessions on the same repo simultaneously.
