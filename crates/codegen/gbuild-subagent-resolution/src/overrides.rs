...
//!
//! Extracted from `gbuild-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use gbuild_tools::implementations::gbuild::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use gbuild_tools::implementations::gbuild::task::types::ModelOverrideProvenance;
