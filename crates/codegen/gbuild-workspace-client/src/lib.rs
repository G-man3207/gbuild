...
//! `gbuild-workspace`. Wire types live in
//! `gbuild_workspace_types::rpc`; this crate adds the connected-state
...
//! own their timeouts.
use gbuild_workspace_types::rpc::agents_md::{AgentConfigFile, DiscoverAgentsMdReq};
use gbuild_workspace_types::rpc::code_nav::{
...
use gbuild_workspace_types::rpc::export_github::{ExportGithubReq, ExportGithubResponse};
use gbuild_workspace_types::rpc::fs::{
...
use gbuild_workspace_types::rpc::git::{
...
use gbuild_workspace_types::rpc::hunks::{
...
use gbuild_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use gbuild_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use gbuild_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use gbuild_workspace_types::rpc::worktree::{
...
use gbuild_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
...
mod tests {
    use super::*;
    use gbuild_workspace_types::rpc::skills::SkillScope;
        ...
        async fn run(&self, _ctx: ToolCallContext, args: Self::Args) -> Result<RawOut, ToolError> {
            ...
            match args.method.as_str() {
                ...
                "workspace.discover_skills" => ok(serde_json::json!([{
                    ...
                    "path": "/workspace/.gbuild/skills/my-skill/SKILL.md",
                    "scope": "local",
                }])),
