...
//!
//! In dev mode, watches ~/.gbuild/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.gbuild/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.gbuild/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = gbuild_config::user_gbuild_home()
