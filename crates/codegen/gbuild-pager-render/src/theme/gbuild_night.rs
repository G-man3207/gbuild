//! GBuildNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// GBuildNight palette — neutral gray base + TokyoNight accent colors.
//
