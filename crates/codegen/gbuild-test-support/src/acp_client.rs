//! ACP stdio clients for testing gbuild sessions end-to-end: the typed
//! [`GBuildStdioClient`] (`agent-client-protocol::ClientSideConnection` —
...
/// Spawn `gbuild agent stdio` with the sandbox's canonical hermetic environment.
...
/// Drives `gbuild agent stdio` with verbatim newline-delimited JSON-RPC lines.
///
/// Exists for wire shapes the typed [`GBuildStdioClient`] (`ClientSideConnection`,
