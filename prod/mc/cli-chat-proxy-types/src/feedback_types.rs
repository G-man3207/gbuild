...
//!
//! These types support the feedback collection system for gBuild sessions.
//! The agent (gbuild-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using gBuild productively! Would you mind sharing quick feedback?".to_string()
}
